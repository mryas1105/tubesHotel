...
class FasilitasHotelController extends Controller
{
    ...
    {
        $fasilitashotel = FaslilitasHotel::all();
        return view('admin/fasilitashotel/index', compact('fasilitashotel'));
    ...
    public function destroy(FaslilitasHotel $fasilitas)
    {
        $fasilitas->delete();
        return redirect('/admin/fasilitashotel')->with('success', 'Berhasil hapus fasilitas hotel!');
    }
